...
import VerMsg from "./verificationMsg";
import {
    validateFirstName,
    validateLastName,
    validatePhone,
...
import bgSignup from "../assests/signup.jpg"
...
const Register = () => {
    ...
    const handleSignUpClick = (e) => {
        ...
        if (isFormValid()) {
            ...
            // }));
            const url = "http://172.18.2.96:8080/api/UserRequests/signup";
            const data = {
    ...
    return (
        <Card bg={bgSignup}>
            <form>
                ...
                <Text variant="primary" size="s">Already have an account?<Text className="inline pl-4" variant="link" decor="u" onClick={navigateToLogin}>Login</Text></Text>
