    ...
    <div className='w-screen p-10 bg-[#F4F7FE]'>
        ...
        <div className=' p-2'>
            <div className='w-full md:w-2/3 m-auto '>
                {/* <h3 className='font-bold text-3xl  mb-1 text-[#2B3674]'>Change in name</h3> */}
                ...
                <div className='w-full'>
                    ...
                    <div className='md:flex justify-between w-full'>
                        ...
                        <div className='relative w-1/2 ml-2'>
                            <label className='flex text-center text-[#2B3674] text-xs'>Specify the connection owner's new name <FaAsterisk className='text-red-500 text-[5px] '/></label>
