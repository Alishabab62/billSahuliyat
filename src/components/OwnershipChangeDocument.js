  ...
  return (
    <div className="w-screen p-10 bg-[#F4F7FE]">
      ...
      <div className="border p-2 bg-white">
        ...
        <div className="w-full md:w-1/2 m-auto border p-6">
          <div class="relative ">
            <ol className="list-[number]">
              ...
              <li class="h-[55px] text-[#2B3674] text-base font-medium">
        ...
        <div className="w-full md:w-1/2 m-auto border p-6 mt-4 overflow-auto">
          <div>
            <div>
              <table>
                <tbody>
...
export default OwnershipChangeDocument